...
$Hecho = mysqli_real_escape_string($link,"0");

$Mostrar = mysqli_real_escape_string($link, "1");
if ($Nota){
    $sql = "INSERT INTO tareas (Descripcion, AsigID, fecha,Nota ) VALUES ( '$Tarea', '$AsigId', '$Fecha', '$Nota')";
} else {
    $sql = "INSERT INTO tareas (Descripcion, AsigID, fecha ) VALUES ( '$Tarea', '$AsigId', '$Fecha')";
}
