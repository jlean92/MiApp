...
<body class="loggedin">
<div class="CasiBody">
    <header ><span id="Titulo">Examenes del grado</span><span><button class="Button" id="logoff" onclick = "window.location.href='cerrar-sesion.php';">Cerrar Sesion</button></span></header>
...
<?php 
    ...
    echo '
        <form action="InsertExamen.php" method="post">
...
?>
            ...
            <button type="submit">Insertar examen</button><br/><br/>
        </form>
...
<?php 
    ...
    $query = "SELECT examenes.ExamenID, examenes.Descripcion,examenes.fecha,examenes.Hecho,examenes.Nota,examenes.Mostrar,asignaturas.nombre,asignaturas.asigId  FROM examenes, asignaturas WHERE examenes.asigID = asignaturas.asigID AND examenes.Mostrar = 1 ORDER BY examenes.fecha";
